...
--
-- Host: localhost:3306
-- Waktu pembuatan: 09 Jan 2026 pada 00.01
-- Versi server: 8.4.3
-- Versi PHP: 8.3.16
...
--
CREATE DATABASE IF NOT EXISTS `yayasan_cms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `yayasan_cms`;
...
INSERT INTO `campaign_programs` (`id`, `image`, `category`, `title`, `description`, `amount_raised`, `goal_amount`, `beneficiaries_count`, `donators_count`, `gallery_images`, `link_url`, `order_position`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'uploads/campaigns/program_1767677877_695c9fb588172.jpg', 'Distribusi Makanan', 'Program Berbagi Makanan untuk Dhuafa', 'Program distribusi makanan untuk membantu masyarakat kurang mampu mendapatkan makanan bergizi. Kami menyalurkan paket makanan secara rutin kepada keluarga yang membutuhkan.', 31000.00, 34900.00, 250, 120, NULL, '#', 1, 1, '2026-01-04 06:02:22', '2026-01-06 05:38:28'),
(2, 'uploads/campaigns/program_1767510295_695a11170aca1.png', 'Pendidikan', 'Beasiswa Pendidikan Anak Yatim', 'Program beasiswa pendidikan untuk anak-anak yatim dan dhuafa agar dapat melanjutkan pendidikan mereka dari tingkat SD hingga perguruan tinggi.', 24000.00, 34900.00, 150, 85, NULL, '#', 2, 1, '2026-01-04 06:02:22', '2026-01-04 07:04:55'),
(3, 'uploads/campaigns/program_1767509886_695a0f7e880bc.jpg', 'Pembangunan', 'Renovasi Masjid dan Musholla', 'Program renovasi dan pembangunan masjid serta musholla di daerah-daerah yang membutuhkan untuk meningkatkan fasilitas ibadah masyarakat.', 100000.00, 800000.00, 500, 200, NULL, '#', 3, 1, '2026-01-04 06:58:06', '2026-01-04 06:58:06'),
(4, 'uploads/campaigns/program_1767518372_695a30a4eb422.jpg', 'Kesehatan', 'Layanan Kesehatan Gratis', 'Program layanan kesehatan gratis untuk masyarakat kurang mampu meliputi pemeriksaan kesehatan, pengobatan, dan pembagian obat-obatan.', 100000.00, 200000.00, 300, 95, NULL, '#', 4, 1, '2026-01-04 09:19:32', '2026-01-04 09:19:32');
...
--
-- Struktur dari tabel `KategoriLegalitasAbout`
--

CREATE TABLE `KategoriLegalitasAbout` (
  `id` int NOT NULL AUTO_INCREMENT,
  `jenis_akta` varchar(255) NOT NULL,
  `deskripsi` text NOT NULL,
  `nomor_akta` varchar(255) NOT NULL,
  `tahun_akta` int NOT NULL,
  `status` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `KategoriLegalitasAbout`
--

INSERT INTO `KategoriLegalitasAbout` (`id`, `jenis_akta`, `deskripsi`, `nomor_akta`, `tahun_akta`, `status`) VALUES
(1, 'Akta Notaris', 'Akta Pendirian Yayasan yang disahkan oleh Notaris sesuai dengan peraturan perundang-undangan yang berlaku.', 'No. 123/2014', 2014, 'Resmi'),
(2, 'SK Kemenkumham', 'Surat Keputusan pengesahan dari Kementerian Hukum dan HAM Republik Indonesia.', 'AHU-0012345.AH.01.04', 2014, 'Resmi'),
(3, 'NPWP', 'Nomor Pokok Wajib Pajak yayasan yang terdaftar di Direktorat Jenderal Pajak.', '12.345.678.9-012.000', 2014, 'Resmi'),
(4, 'Izin Operasional', 'Izin operasional dari Kementerian Agama untuk kegiatan sosial keagamaan.', 'Kemenag/2015/789', 2015, 'Resmi'),
(5, 'NIB', 'Nomor Induk Berusaha sebagai identitas pelaku usaha yang terdaftar di OSS.', '1234567890123', 2020, 'Resmi'),
(6, 'Terdaftar di Baznas', 'Sebagai lembaga pengelola zakat yang diakui oleh Badan Amil Zakat Nasional.', 'REG-2020-4567', 2020, 'Resmi');

--
-- AUTO_INCREMENT untuk tabel `KategoriLegalitasAbout`
--
ALTER TABLE `KategoriLegalitasAbout`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
